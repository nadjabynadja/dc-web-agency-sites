    ...
    <main className="bg-white">
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-3xl mx-auto">
          ...
          >
            At Artisan Bakery & Cafe, we're committed to delivering exceptional service in Bakery/Cafe. With a rating of 4.6/5 stars from 267 happy customers, we pride ourselves on quality, attention to detail, and genuine care for our clients.
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <h3 className="text-xl font-bold mb-2">Sourdough bread</h3>
            ...
            <motion.div
              ...
              className="bg-white p-6 rounded-lg shadow-md"
            >
              <h3 className="text-xl font-bold mb-2">Espresso drinks</h3>
              <p className="text-gray-600">Premium quality service tailored to your needs.</p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            >
              <p className="text-gray-700 italic mb-2">"Fresh baked goods every morning. Incredible quality."</p>
            ...
            <motion.div
              ...
              className="bg-gray-50 p-6 rounded-lg border-l-4 border-yellow-500"
            >
              <p className="text-gray-700 italic mb-2">"The croissants are buttery perfection."</p>
              <p className="text-yellow-500 text-sm font-semibold">★★★★★</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0 }}
              ...
              className="bg-gray-50 p-6 rounded-lg border-l-4 border-yellow-500"
            >
              <p className="text-gray-700 italic mb-2">"This is my new favorite spot. Come early or it sells out."</p>
              <p className="text-yellow-500 text-sm font-semibold">★★★★★</p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-300 mb-6">2750 Woodley Rd NW, Washington, DC 20008</p>
              <h3 className="text-2xl font-bold mb-4">Hours</h3>
              <p className="text-gray-300 whitespace-pre-line">Mon-Fri 6am-8pm, Sat-Sun 7am-8pm</p>
            </div>
            <div>
      ...
      <footer className="bg-black text-white py-8 px-6 text-center">
        <p>&copy; 2024 Artisan Bakery & Cafe. All rights reserved. Proud Woodley Park business.</p>
      </footer>
    </main>
  );
}
