    ...
    <main className="bg-white">
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-3xl mx-auto">
          ...
          >
            At Dr. Chen's Dental Practice, we're committed to delivering exceptional service in Dentist. With a rating of 4.8/5 stars from 212 happy customers, we pride ourselves on quality, attention to detail, and genuine care for our clients.
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <motion.div
              ...
              className="bg-white p-6 rounded-lg shadow-md"
            >
              <h3 className="text-xl font-bold mb-2">Cleanings</h3>
              <p className="text-gray-600">Premium quality service tailored to your needs.</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            >
              <p className="text-gray-700 italic mb-2">"Friendly, professional, painless cleaning experience."</p>
            ...
            <motion.div
              ...
              className="bg-gray-50 p-6 rounded-lg border-l-4 border-yellow-500"
            >
              <p className="text-gray-700 italic mb-2">"Dr. Chen is thorough and explains everything."</p>
              <p className="text-yellow-500 text-sm font-semibold">★★★★★</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0 }}
              ...
              className="bg-gray-50 p-6 rounded-lg border-l-4 border-yellow-500"
            >
              <p className="text-gray-700 italic mb-2">"Best dental experience I've had."</p>
              <p className="text-yellow-500 text-sm font-semibold">★★★★★</p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-300 mb-6">3100 Woodley Rd NW, Washington, DC 20008</p>
              <h3 className="text-2xl font-bold mb-4">Hours</h3>
              <p className="text-gray-300 whitespace-pre-line">Mon-Thu 8am-5pm, Fri 8am-4pm, Sat 9am-3pm, Closed Sun</p>
            </div>
            <div>
              <h3 className="text-2xl font-bold mb-4">Contact</h3>
              <a href="tel:(202) 362-9876" className="text-yellow-400 text-xl font-bold hover:underline">
                (202) 362-9876
              </a>
            </div>
          </div>
      ...
      <footer className="bg-black text-white py-8 px-6 text-center">
        <p>&copy; 2024 Dr. Chen's Dental Practice. All rights reserved. Proud Woodley Park business.</p>
      </footer>
    </main>
  );
}
