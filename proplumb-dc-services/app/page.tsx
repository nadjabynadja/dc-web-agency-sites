    ...
    <main className="bg-white">
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-3xl mx-auto">
          ...
          >
            At ProPlumb DC Services, we're committed to delivering exceptional service in Plumber. With a rating of 4.6/5 stars from 178 happy customers, we pride ourselves on quality, attention to detail, and genuine care for our clients.
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <h3 className="text-xl font-bold mb-2">Pipe repair</h3>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            >
              <p className="text-gray-700 italic mb-2">"Fast response, fixed the problem right away."</p>
            ...
            <motion.div
              ...
              className="bg-gray-50 p-6 rounded-lg border-l-4 border-yellow-500"
            >
              <p className="text-gray-700 italic mb-2">"Fair pricing, professional work, highly reliable."</p>
              <p className="text-yellow-500 text-sm font-semibold">★★★★★</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0 }}
              ...
              className="bg-gray-50 p-6 rounded-lg border-l-4 border-yellow-500"
            >
              <p className="text-gray-700 italic mb-2">"Called them Sunday emergency, showed up in 30 mins. Amazing."</p>
              <p className="text-yellow-500 text-sm font-semibold">★★★★★</p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-300 mb-6">1624 New Hampshire Ave NW, Washington, DC 20009</p>
              <h3 className="text-2xl font-bold mb-4">Hours</h3>
              <p className="text-gray-300 whitespace-pre-line">Mon-Sat 8am-6pm, Emergency 24/7</p>
            </div>
            <div>
              <h3 className="text-2xl font-bold mb-4">Contact</h3>
              <a href="tel:(202) 555-3344" className="text-yellow-400 text-xl font-bold hover:underline">
                (202) 555-3344
              </a>
            </div>
          </div>
      ...
      <footer className="bg-black text-white py-8 px-6 text-center">
        <p>&copy; 2024 ProPlumb DC Services. All rights reserved. Proud Adams Morgan business.</p>
      </footer>
    </main>
  );
}
